...
const Shoes_desktop_women = () => {
    ...
    const linksCategories = [
        "/catalog/sneakers_desktop_women",
                            ...
                            <div key={idx} className={styles.brandCircle}>
                                ...
                                >
                                    <div className={styles.circle}>
                                        <Image
                                            src={`https://storage.yandexcloud.net/sellout-bucket/Images%20New%20Frontend/Desktop/Women/Products/Shoes/Brands/${idx + 1}.png`}
                                            alt="Brand Image"
                        ...
                        {['Кроссовки', 'Лоферы', 'Шлёпки', 'Мюли', 'Босоножки', 'Зимние кроссов..', 'Пляжные санда..', 'Все туфли', 'Высокие', 'Средние', 'Низкие', 'Слипоны', 'Мокасины', 'Эспадрильи', 'Все ботинки', 'Толстая подошва', 'Ботфорты', 'Средние', 'Ботильоны', 'Мартинсы', 'Тимберленды', 'Челси'].map((category, idx) => (
                            ...
                            >
                                <div key={idx} className={styles.categoryItem}>
                                    <Image
                                        src={`https://storage.yandexcloud.net/sellout-bucket/Images%20New%20Frontend/Desktop/Women/Products/Shoes/Categories/${idx + 1}.png`}
                                        alt={category}
                                        width={700}
                                        height={700}
