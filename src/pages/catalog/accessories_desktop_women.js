...
import styles from '@/styles/CatalogAccessoriesDesktopWomen.module.css'
...
const CatalogAccessoriesDesktopMen = () => {
    const linksBrands = [
            ...
            <div className={styles.catalogContainer}>
                ...
                <div className={styles.categoriesSection}>
                    ...
                    <div className={styles.categoriesGrid}>
                        {['Кепки', 'Очки', 'Панамы', 'Часы', 'Оправы', 'Collectibles', 'Ремни', 'Шапки', 'Шарфы', 'Кольца', 'Цепочки', 'Браслеты', 'Перчатки', 'Очешники', 'Духи', 'Косметика', 'Галстуки', 'Брелоки', 'Серьги', 'Чехлы', 'Мячи', 'Мячи', 'Для техники', 'Другие'].map((category, idx) => (
                            <Link
                            ...
                            >
                                <div key={idx} className={styles.categoryItem}>
                                    <Image
                                        src={`https://storage.yandexcloud.net/sellout-bucket/Images%20New%20Frontend/Desktop/Women/Products/Accessories/Categories/${idx + 1}.png`}
                                        alt={category}
                                        width={700}
                                        height={700}
                            ...
                            <div key={idx} className={styles.brandCircle}>
                                ...
                                >
                                    <div className={styles.circle}>
                                        <Image
                                            src={`https://storage.yandexcloud.net/sellout-bucket/Images%20New%20Frontend/Desktop/Women/Products/Accessories/Brands/${idx + 1}.png`}
                                            alt="Brand Image"
...
export default observer(CatalogAccessoriesDesktopMen);