            ...
            <div className={styles.catalogContainer}>
                        ...
                        {['Все кроссовки и кеды', 'Высокие кроссовки', 'Низкие кроссовки', 'Баскетбольные кроссовки', 'Футбольные бутсы', 'Кроссовки для спорта'].map((category, idx) => (
                            ...
                            >
                                <div key={idx} className={styles.categoryItem}>
                                    <Image
                                        src={`https://storage.yandexcloud.net/sellout-bucket/Images%20New%20Frontend/Desktop/Men/Products/Sneakers/Categories/${idx + 1}.png`}
                                        alt={category}
                                        width={700}
                                        height={700}
                            ...
                            <div key={idx} className={styles.brandCircle1}>
                                ...
                                >
                                    <div className={styles.circle1}>
                                        <Image
                                            src={`https://storage.yandexcloud.net/sellout-bucket/Images%20New%20Frontend/Desktop/Men/Products/Sneakers/Brands/${idx + 1}.png`}
                                            alt="Brand Image"
                ...
                <div className={styles.brandsSection}>
                    <div>
                        ...
                        >
                            <Image
                                src={`https://storage.yandexcloud.net/sellout-bucket/Images%20New%20Frontend/Desktop/Men/Products/Sneakers/Photos/1.png`}
                                alt=''
                                width={1000}
                                height={1000}
                            ...
                            <div key={idx} className={styles.brandCircle}>
                                ...
                                >
                                    <div className={styles.circle}>
                                        <Image
                                            src={`https://storage.yandexcloud.net/sellout-bucket/Images%20New%20Frontend/Desktop/Men/Products/Sneakers/Nike/${idx + 1}.png`}
                                            alt="Brand Image"
                ...
                <div className={styles.brandsSection}>
                    <div>
                        ...
                        >
                            <Image
                                src={`https://storage.yandexcloud.net/sellout-bucket/Images%20New%20Frontend/Desktop/Men/Products/Sneakers/Photos/2.png`}
                                alt=''
                                width={1000}
                                height={1000}
                                style={{width: '326px', height: 'auto'}}
                        ...
                        {Array.from({length: 24}).map((_, idx) => (
                            <div key={idx} className={styles.brandCircle}>
                                ...
                                >
                                    <div className={styles.circle}>
                                        <Image
                                            src={`https://storage.yandexcloud.net/sellout-bucket/Images%20New%20Frontend/Desktop/Men/Products/Sneakers/Jordan/${idx + 1}.png`}
                                            alt="Brand Image"
                                            className={styles.circleImage}
                                            width={700}
                                            height={700}
                ...
                <div className={styles.brandsSection}>
                    <div>
                        ...
                        >
                            <Image
                                src={`https://storage.yandexcloud.net/sellout-bucket/Images%20New%20Frontend/Desktop/Men/Products/Sneakers/Photos/3.png`}
                                alt=''
                                width={1000}
                                height={1000}
                                style={{width: '326px', height: 'auto'}}
                        ...
                        {Array.from({length: 16}).map((_, idx) => (
                            <div key={idx} className={styles.brandCircle}>
                                ...
                                >
                                    <div className={styles.circle}>
                                        <Image
                                            src={`https://storage.yandexcloud.net/sellout-bucket/Images%20New%20Frontend/Desktop/Men/Products/Sneakers/New Balance/${idx + 1}.png`}
                                            alt="Brand Image"
                                            className={styles.circleImage}
                                            width={700}
                                            height={700}
                ...
                <div className={styles.brandsSection}>
                    <div>
                        ...
                        >
                            <Image
                                src={`https://storage.yandexcloud.net/sellout-bucket/Images%20New%20Frontend/Desktop/Men/Products/Sneakers/Photos/4.png`}
                                alt=''
                                width={1000}
                                height={1000}
                                style={{width: '326px', height: 'auto'}}
                        ...
                        {Array.from({length: 40}).map((_, idx) => (
                            <div key={idx} className={styles.brandCircle}>
                                ...
                                >
                                    <div className={styles.circle}>
                                        <Image
                                            src={`https://storage.yandexcloud.net/sellout-bucket/Images%20New%20Frontend/Desktop/Men/Products/Sneakers/adidas/${idx + 1}.png`}
                                            alt="Brand Image"
                                            className={styles.circleImage}
                                            width={700}
                                            height={700}
                ...
                <div className={styles.brandsSection}>
                    <div>
                        ...
                        >
                            <Image
                                src={`https://storage.yandexcloud.net/sellout-bucket/Images%20New%20Frontend/Desktop/Men/Products/Sneakers/Photos/5.png`}
                                alt=''
                                width={1000}
                                height={1000}
                                style={{width: '326px', height: 'auto'}}
                        ...
                        {Array.from({length: 10}).map((_, idx) => (
                            <div key={idx} className={styles.brandCircle}>
                                ...
                                >
                                    <div className={styles.circle}>
                                        <Image
                                            src={`https://storage.yandexcloud.net/sellout-bucket/Images%20New%20Frontend/Desktop/Men/Products/Sneakers/Vans/${idx + 1}.png`}
                                            alt="Brand Image"
                                            className={styles.circleImage}
                                            width={700}
                                            height={700}
                ...
                <div className={styles.brandsSection}>
                    <div>
                        ...
                        >
                            <Image
                                src={`https://storage.yandexcloud.net/sellout-bucket/Images%20New%20Frontend/Desktop/Men/Products/Sneakers/Photos/6.png`}
                                alt=''
                                width={1000}
                                height={1000}
                                style={{width: '326px', height: 'auto'}}
                        ...
                        {Array.from({length: 14}).map((_, idx) => (
                            <div key={idx} className={styles.brandCircle}>
                                ...
                                >
                                    <div className={styles.circle}>
                                        <Image
                                            src={`https://storage.yandexcloud.net/sellout-bucket/Images%20New%20Frontend/Desktop/Men/Products/Sneakers/Asics/${idx + 1}.png`}
                                            alt="Brand Image"
                                            className={styles.circleImage}
                                            width={700}
                                            height={700}
                ...
                <div className={styles.brandsSection}>
                    <div>
                        ...
                        >
                            <Image
                                src={`https://storage.yandexcloud.net/sellout-bucket/Images%20New%20Frontend/Desktop/Men/Products/Sneakers/Photos/7.png`}
                                alt=''
                                width={1000}
                                height={1000}
                        ...
                        {Array.from({length: 5}).map((_, idx) => (
                            <div key={idx} className={styles.brandCircle}>
                                ...
                                >
                                    <div className={styles.circle}>
                                        <Image
                                            src={`https://storage.yandexcloud.net/sellout-bucket/Images%20New%20Frontend/Desktop/Men/Products/Sneakers/Converse/${idx + 1}.png`}
                                            alt="Brand Image"
                                            className={styles.circleImage}
                                            width={700}
                                            height={700}
                ...
                <div className={styles.brandsSection}>
                    <div>
                        ...
                        >
                            <Image
                                src={`https://storage.yandexcloud.net/sellout-bucket/Images%20New%20Frontend/Desktop/Men/Products/Sneakers/Photos/8.png`}
                                alt=''
                                width={1000}
                                height={1000}
                                style={{width: '430px', height: 'auto'}}
                        ...
                        {Array.from({length: 3}).map((_, idx) => (
                            <div key={idx} className={styles.brandCircle}>
                                ...
                                >
                                    <div className={styles.circle}>
                                        <Image
                                            src={`https://storage.yandexcloud.net/sellout-bucket/Images%20New%20Frontend/Desktop/Men/Products/Sneakers/Anta/${idx + 1}.png`}
                                            alt="Brand Image"
                                            className={styles.circleImage}
                                            width={700}
                                            height={700}
                ...
                <div className={styles.brandsSection}>
                    <div>
                        ...
                        >
                            <Image
                                src={`https://storage.yandexcloud.net/sellout-bucket/Images%20New%20Frontend/Desktop/Men/Products/Sneakers/Photos/9.png`}
                                alt=''
                                width={1000}
                                height={1000}
                                style={{width: '430px', height: 'auto'}}
                        ...
                        {Array.from({length: 4}).map((_, idx) => (
                            <div key={idx} className={styles.brandCircle}>
                                ...
                                >
                                    <div className={styles.circle}>
                                        <Image
                                            src={`https://storage.yandexcloud.net/sellout-bucket/Images%20New%20Frontend/Desktop/Men/Products/Sneakers/Li-Ning/${idx + 1}.png`}
                                            alt="Brand Image"
                                            className={styles.circleImage}
                                            width={700}
                                            height={700}
                ...
                <div className={styles.brandsSection}>
                    <div>
                        ...
                        >
                            <Image
                                src={`https://storage.yandexcloud.net/sellout-bucket/Images%20New%20Frontend/Desktop/Men/Products/Sneakers/Photos/10.png`}
                                alt=''
                                width={1000}
                                height={1000}
                                style={{width: '430px', height: 'auto'}}
                        ...
                        {Array.from({length: 16}).map((_, idx) => (
                            <div key={idx} className={styles.brandCircle}>
                                ...
                                >
                                    <div className={styles.circle}>
                                        <Image
                                            src={`https://storage.yandexcloud.net/sellout-bucket/Images%20New%20Frontend/Desktop/Men/Products/Sneakers/Puma/${idx + 1}.png`}
                                            alt="Brand Image"
                                            className={styles.circleImage}
                                            width={700}
                                            height={700}
                ...
                <div className={styles.brandsSection}>
                    <div>
                        ...
                        >
                            <Image
                                src={`https://storage.yandexcloud.net/sellout-bucket/Images%20New%20Frontend/Desktop/Men/Products/Sneakers/Photos/11.png`}
                                alt=''
                                width={1000}
                                height={1000}
                                style={{width: '430px', height: 'auto'}}
                        ...
                        {Array.from({length: 6}).map((_, idx) => (
                            <div key={idx} className={styles.brandCircle}>
                                ...
                                >
                                    <div className={styles.circle}>
                                        <Image
                                            src={`https://storage.yandexcloud.net/sellout-bucket/Images%20New%20Frontend/Desktop/Men/Products/Sneakers/Reebok/${idx + 1}.png`}
                                            alt="Brand Image"
                                            className={styles.circleImage}
                                            width={700}
                                            height={700}
                ...
                <div className={styles.brandsSection}>
                    <div>
                        ...
                        >
                            <Image
                                src={`https://storage.yandexcloud.net/sellout-bucket/Images%20New%20Frontend/Desktop/Men/Products/Sneakers/Photos/12.png`}
                                alt=''
                                width={1000}
                                height={1000}
                                style={{width: '430px', height: 'auto'}}
                        ...
                        {Array.from({length: 10}).map((_, idx) => (
                            <div key={idx} className={styles.brandCircle}>
                                ...
                                >
                                    <div className={styles.circle}>
                                        <Image
                                            src={`https://storage.yandexcloud.net/sellout-bucket/Images%20New%20Frontend/Desktop/Men/Products/Sneakers/Under Armour/${idx + 1}.png`}
                                            alt="Brand Image"
                                            className={styles.circleImage}
                                            width={700}
                                            height={700}
