...
import sMob from "@/components/shared/UI/EventsMainPage/EventsMainPageMob.module.css";
                    ...
                    desktopStore.isDesktop ?
                            ...
                            <div className={s.contentWrapper}>
                                <div className={s.topBlock}>
                                    ...
                                    <div className={s.textBlock}>
                                        ...
                                        <div className={s.text1}>Ищете идеальное место для празднования важного
                                            события?
                                        </div>
                                        <div className={s.text1}>Мы предлагаем возможность сделать ваш день
                                            по-настоящему
                                            особенным!
                                        </div>
                                    </div>
                                ...
                                <div className={s.bottomBlock}>
                                    <div className={s.textBlock} style={{marginTop: 120}}>
                                        ...
                                        <div className={s.text1} style={{marginTop: 20}}>Всё, что нужно, – это выбрать
                                            мастер-класс,
                                            а мы позаботимся о деталях: месте, обстановке, материалах и поддержке на
                                            каждом этапе!
                                        </div>
                                    </div>
                                    <div className={s.imageBlock}>
                        ...
                        <div className={sMob.sectionWrapper}>
                            <div className={sMob.contentWrapper}>
                                ...
                                <Image src={welcomeFlowerLogo} alt="Emoji 1"
                                       className={`${sMob.flower} ${sMob.flower1}`}/>
                                <Image src={welcomeFlowerLogo} alt="Emoji 2"
                                       className={`${sMob.flower} ${sMob.flower2}`}/>
                                <Image src={welcomeFlowerLogo} alt="Emoji 3"
                                       className={`${sMob.flower} ${sMob.flower3}`}/>
                                <Image src={welcomeFlowerLogo} alt="Emoji 4"
                                       className={`${sMob.flower} ${sMob.flower4}`}/>
                                <Image src={welcomeFlowerLogo} alt="Emoji 5"
                                       className={`${sMob.flower} ${sMob.flower5}`}/>
                                <Image src={welcomeFlowerLogo} alt="Emoji 8"
                                       className={`${sMob.flower} ${sMob.flower8}`}/>
                                <Image src={welcomeFlowerLogo} alt="Emoji 9"
                                       className={`${sMob.flower} ${sMob.flower9}`}/>
                            </div>
                            <ContactModalEvents isOpen={contactOpen} handleClose={closeContact}/>
                        </div>
                }
